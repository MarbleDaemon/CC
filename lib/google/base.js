...
goog.inherits = function (childCtor, parentCtor)
{
	...
	/** @constructor */
	var tempCtor = new sc.globals.Function;
	/*function tempCtor()
	 {
	 };*/
	tempCtor[PROTOTYPE] = parentCtor[PROTOTYPE];
	tempCtor[PROTOTYPE].superClass_ = parentCtor;
 ...
 * @param {Function} parentCtor Parent class.
 */
goog.inherits2 = function (childCtor, parentCtor)
{
	/** @constructor */
	function tempCtor()
	{
...
{
	var childClass = def.constructor;
	...
	goog.defineClass.applyProperties_(childClass.prototype, def);
	...
	if (statics != null)
	{
		...
		{
			goog.defineClass.applyProperties_(childClass, statics);
		}
	}
 ...
 * @return {!Function} The class constructor.
 */
goog.defineClass2 = function (superClass, def)
{
